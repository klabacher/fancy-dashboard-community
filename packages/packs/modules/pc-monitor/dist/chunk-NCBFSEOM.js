...
var usePCMonitorStore = create((set, _get) => ({
  specs: null,
  stats: null,
  isConnected: false,
  lastError: null,
  ...
  updateDashboardLayout: (layout2) => set({ dashboardLayout: layout2 }),
...
var useCPUStats = () => usePCMonitorStore((s) => s.stats?.cpu ?? null);
var useRAMStats = () => usePCMonitorStore((s) => s.stats?.ram ?? null);
var useGPUStats = () => usePCMonitorStore((s) => s.stats?.gpu ?? null);
var useTempStats = () => usePCMonitorStore((s) => s.stats?.temps ?? null);
var useDashboardLayout = () => usePCMonitorStore((s) => s.dashboardLayout);
...
var unsubscribeTelemetry = null;
var loadedSpecs = false;
...
function MeasureLayout(props) {
  ...
  const layoutGroup = useContext2(LayoutGroupContext);
  return jsx(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: useContext2(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
import { useContext as useContext4, useRef, useInsertionEffect, useEffect as useEffect4 } from "react";
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const reducedMotionConfig = useContext4(MotionConfigContext).reducedMotion;
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return jsxs(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? jsx2(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component2, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement)] });
  }
...
import { forwardRef as forwardRef2, useRef as useRef3, useEffect as useEffect5 } from "react";
...
var ReorderContext = createContext7(null);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  return jsx3(Component2, { ...props, ref: externalRef, ignoreStrict: true, children: jsx3(ReorderContext.Provider, { value: context, children }) });
}
...
import { forwardRef as forwardRef3, useContext as useContext8 } from "react";
...
import { useContext as useContext7, useState, useEffect as useEffect6 } from "react";
function useMotionValue(initial) {
  const value = useConstant(() => motionValue(initial));
  const { isStatic } = useContext7(MotionConfigContext);
  if (isStatic) {
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  const Component2 = useConstant(() => motion[as]);
  const context = useContext8(ReorderContext);
  const point = {
  ...
  return jsx4(Component2, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
...
function Sparkline({
  ...
  if (data.length < 2) {
    return /* @__PURE__ */ jsx5(
      "div",
      {
        ...
        style: { width, height },
        children: /* @__PURE__ */ jsx5("span", { className: "text-[10px] text-white/30", children: "No data" })
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxs2("div", { className: `relative ${className}`, style: { width, height }, children: [
    /* @__PURE__ */ jsxs2(
      "svg",
      {
        width,
        ...
        children: [
          /* @__PURE__ */ jsx5("defs", { children: /* @__PURE__ */ jsxs2("linearGradient", { id: gradientId, x1: "0", x2: "0", y1: "0", y2: "1", children: [
            /* @__PURE__ */ jsx5("stop", { offset: "0%", stopColor: color2, stopOpacity: 0.3 }),
            /* @__PURE__ */ jsx5("stop", { offset: "100%", stopColor: color2, stopOpacity: 0 })
          ] }) }),
          showGradient && /* @__PURE__ */ jsx5(
            motion.path,
            {
              d: areaPath,
              fill: `url(#${gradientId})`,
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx5(
          "svg",
          {
            ...
            children: /* @__PURE__ */ jsx5("path", { d: "M4 0L8 6H0L4 0Z" })
          }
        )
      }
    )
