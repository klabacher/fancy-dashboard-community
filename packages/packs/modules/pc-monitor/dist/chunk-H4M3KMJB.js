...
function RAMWidget({
  ...
  if (!stats) {
    return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-full w-full bg-black/20 rounded-lg", children: /* @__PURE__ */ jsx(MemoryStick, { className: "w-5 h-5 text-white/30 animate-pulse" }) });
  }
  ...
  if (compact) {
    return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 h-full w-full p-2 bg-black/30 backdrop-blur-md rounded-lg", children: [
      /* @__PURE__ */ jsx("div", { className: "p-1.5 rounded-md bg-purple-500/20", children: /* @__PURE__ */ jsx(MemoryStick, { className: "w-4 h-4 text-purple-400" }) }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full w-full p-3 bg-black/30 backdrop-blur-md rounded-lg overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "p-1.5 rounded-md bg-purple-500/20", children: /* @__PURE__ */ jsx(MemoryStick, { className: "w-4 h-4 text-purple-400" }) }),
        /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-white/80", children: "RAM" })
      ] }),
      /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-white/40", children: [
        stats.used,
        "/",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[10px] text-white/40 mb-2", children: [
